    ...
    <section class="cont-carrucel">
        <div class="breadcrumbs">
            <ul class="bread-links">
                ...
                <li class="link-bread"><p class="a-bread link_breadcrumbs_active">Todos los televisores</p></li>
            </ul>
        </div>
        <div class="slider">
            <ul>
                <li><img src="./img/760979-01-02_x1x.jpg_2118499843.webp" alt="imgs"></li>
                <li><img src="./img/televisores4K.jpg" alt="imgs"></li>
                <li><img src="./img/Usabildiad-LG-TV-Nanocell.webp" alt="imgs"></li>
                <li><img src="./img/sony-8k-2019.webp" alt="imgs"></li>
            </ul>
        </div>
    </section>
    <div class="main" id="move-content">
        <div class="cards">
                <div class="card-produc">
                    ...
                    <div class="card-img">
                        <img class="imgTele" src="./img/1567023886_456249_1567026576_noticia_normal_recorte1.jpg" alt="img">
                    </div>
                    <div class="info">
                    ...
                    <a href="productos.php" class="card-butom">
                        <div class="icono">
                            <i class="fas fa-tv"></i>
                        </div>
                ...
                <div class="card-produc">
                    <div class="card-title">
                        <h1>Samsung QLED 8K Q900R</h1>
                        <hr>
                    </div>
                    <div class="card-img">
                        <img class="imgTele" src="./img/Gollo-pantalla-800x600.jpg" alt="img">
                    </div>
                    <div class="info">
                ...
                <div class="card-produc">
                    <div class="card-title">
                        <h1>Samsung SUHD Serie 9</h1>
                        <hr>
                    </div>
                    <div class="card-img">
                        <img class="imgTele" src="./img/las-mejores-y-mas-asequibles-smart-tv-que-deberias-comprar-para-tu-salon.jpg" alt="img">
                    </div>
                    <div class="info">
