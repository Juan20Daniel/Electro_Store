    ...
    <section class="cont-carrucel">
        <div class="breadcrumbs">
            <ul class="bread-links">
                ...
                <li class="link-bread"><a class="a-bread a-hover" href="tele.php">Televisores</a></li>
                <li class="link-bread"><p class="a-bread link_breadcrumbs_active">Smart TV 4K Crystal TU8500</p></li>
            </ul>
        </div>
    </section>
            ...
            <div class="cont-inform">
                <div class="cont-producto">
                    <div class="img-producto">
                        <img class="imagen-produc"  src="./img/1567023886_456249_1567026576_noticia_normal_recorte1.jpg" alt="img">
                    </div>
                    <div class="img-producto">
                        <img class="imagen-produc"  src="./img/ultrahd.su-Sony-KD-55XF7077-kommutacija.jpg" alt="img">
                    </div>
                </div>
                <div class="cont-caracteris">
                    <h1 class="title-info">Smart TV 4K Crystal TU8500</h1>
                    <hr>
                    <p class="info pro">
                        Smart TV 4K Crystal UHD TU8500. Sumérgete en la imagen con una gama de colores más amplia. 
                    ...
                    <div class="produc-info">
                        ...
                        <ul class="list-carac">
                            <li><p class="info-text">Pantalla de 70 pulgadas.</p></li>
                         </ul>
                         <ul class="list-carac">
                             <li><p class="info-text">Resolución 7680 x 4320 píxeles.</p></li>
                         </ul>
                         <ul class="list-carac">
                         ...
                         <ul class="list-carac">
                             <li><p class="info-text">Disfruta de las mejores aplicaciones para programas, peliculas y series como Netflix, Youtube, PrimeVideo, Hulu, y muchas mas.</p></li>
                         </ul>
                         <ul class="list-carac">
                             <li><p class="info-text">Vea sus programas favoritos, películas y entretenimiento deportivo con un excepcional detalle de alta definición.</p></li>
                         </ul>
                         <ul class="list-carac">
                             <li><p class="info-text">Ahora puede conectar fácilmente su cámara digital u otro dispositivo USB para ver archivos JPEG compatibles.</p></li>
                         </ul>
                         <ul class="list-carac">
                             <li><p class="info-text">Las capacidades de salida de audio, audio digital y USB le permiten personalizar aún más la experiencia de visualización y escucha de su televisor.</p></li>
                         </ul>
                    </div>
                </div>
            </div>
