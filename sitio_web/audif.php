    ...
    <section class="cont-carrucel">
        <div class="breadcrumbs">
            <ul class="bread-links">
                ...
                <li class="link-bread"><p class="a-bread link_breadcrumbs_active">Todos los audífonos</p></li>
            </ul>
        </div>
        <div class="slider">
            <ul>
                <li><img src="./img/astro-a20-inalambrico.webp" alt="imgs"></li>
                <li><img src="./img/Logitech-ASTRO-A20-Wireless-Gaming-Headset-1.jpg" alt="imgs"></li>
                <li><img src="./img/AudifonoS.jpg" alt="imgs"></li>
                <li><img src="./img/audifonos-cancelacion-ruido-sony-wh-1000x-m3.jpg" alt="imgs"></li>
            </ul>
        </div>
    </section>
    <div class="main" id="move-content">
        <div class="cards">
            <div class="card-produc">
                ...
                <div class="card-img">
                    <img class="imgTele" src="./img/2-3.jpg" alt="img" />
                </div>
                <div class="info">
                    <p class="caracteristicas">Tecnología BLUETOOTH y NFC</p>
                    <p class="caracteristicas">Audio de alta calidad con DSEE HX y LDAC</p>
                    <p class="caracteristicas">Costo $ 7,399.00 pesos</p>
                </div>
                <a href="productAudi.php" class="card-butom">
                    <div class="icono">
            ...
            <div class="card-produc">
                ...
                <div class="card-img">
                    <img class="imgTele" src="./img/450_1000.jpg" alt="img">
                </div>
                <div class="info">
                    <p class="caracteristicas">Tecnología BLUETOOTH</p>
                    <p class="caracteristicas">Costo $ 8,499 pesos</p>
                    <p class="caracteristicas">Costo $ 1,999 pesos</p>
                </div>
                <a href="productAudi.php" class="card-butom">
                    <div class="icono">
                        <i class="fas fa-headphones-alt"></i>
            ...
            <div class="card-produc">
                <div class="card-title">
                    <h1>Kotion Each G9000 black y red</h1>
                    <hr />
                </div>
                <div class="card-img">
                    <img class="imgTele" src="./img/audifonos-cancelacion-ruido-sony-wh-1000x-m3.jpg" alt="img">
                </div>
                <div class="info">
                    <p class="caracteristicas">Compatible con PlayStation 4, Nueva Xbox One, PC, Nintendo 3DS, computadora portátil, PSP, tableta, iPad, computadora y teléfonos móviles.</p>
                    <p class="caracteristicas">Costo $ 2,401. pesos</p>
                </div>
                <a href="productAudi.php" class="card-butom">
                    <div class="icono">
                        <i class="fas fa-headphones-alt"></i>
