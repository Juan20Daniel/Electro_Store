<?php
    ...
    if(!isset($_SESSION["usuario"])){
        ...
        $coneccion = require("./connect/connection.php");
...
<html leng="es">
    ...
    <body>
        ...
        <div class="contenido-client">
            <div class="cont-card-client">
                <div class="card-client-img">
                    <?php while($fila = mysqli_fetch_assoc($resultado)){ 
                    if($fila['urlImg'] == "picture"){ ?>
                        <img class="img-client" src="img/imagen-perfil-sin-foto.png"> <?php
                    }else{ ?>
                    <img class="img-client" src="img/<?php echo $fila['urlImg']; ?>" ><?php } ?>
                </div>
               <div class="cont-info-cliente">
                    <div class="info-name">
                        <i class="fas fa-user"></i>
                        <p class="name-client"><?php echo $fila["nameUser"]; ?></p>
                    </div>
                    <hr/>
                    <div class="info-name">
                        <i class="fas fa-users"></i>
                        <p class="name-client">Cliente</p>
                    </div>
                    <div class="info-name">
                        <i class="fas fa-envelope"></i>
                        <p class="name-client">Cliente</p>
                    </div><?php } $con->close(); ?>
                    <div class="client-buton">
                        <i class="fas fa-edit"></i>
                        <a class="link-client-update" href="updateUsers.php">Editar perfil</a>
                    </div> 
               </div>
            </div>
        </div>
